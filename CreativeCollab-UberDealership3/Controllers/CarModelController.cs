...
using CreativeCollab_UberDealership3.Models.ViewModels;
...
namespace CreativeCollab_UberDealership3.Controllers
{
    public class CarModelController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            //curl https://localhost:44341/api/carmodeldata/listcarmodels
        ...
        public ActionResult Details(int id)
        {
            ...
            //curl https://localhost:44341/api/carmodeldata/findcarmodel/{id}
        ...
        public ActionResult Create(CarModel carmodel)
        {
            ...
            //curl -H "Content-Type:application/json" -d @car.json https://localhost:44341/api/carmodeldata/addcarmodel
