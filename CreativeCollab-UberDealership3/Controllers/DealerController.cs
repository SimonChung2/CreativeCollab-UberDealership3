...
namespace CreativeCollab_UberDealership3.Controllers
{
    public class DealerController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            //curl https://localhost:44341/api/dealerdata/listdealers
        ...
        public ActionResult Details(int id)
        {
            ...
            //curl https://localhost:44341/api/dealerdata/finddealer/{id}
        ...
        public ActionResult Create(Dealer dealer)
        {
            ...
            //curl -H "Content-Type:application/json" -d @dealer.json https://localhost:44341/api/dealerdata/adddealer
